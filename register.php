    ...
    if (!$verif) {
        ...
        if (empty($info)) {
            ...
            if ($emailExist || $pseudoExist) {
                ...
                $info .= alert("Le mot de passe et la confirmation doivent être identiques.", "secondary");
            } else {

                $mdp = password_hash($mdp, PASSWORD_DEFAULT);

                inscriptionUsers($firstName, $lastName, $pseudo, $email, $mdp, $phone, $civility, $address, $zipCode, $city, $country);
